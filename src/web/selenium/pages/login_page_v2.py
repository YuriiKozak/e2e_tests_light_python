...
class LoginPageV2(BasePage):
    ...
    def remember_me_checkbox(self) -> WebElement:
        return self.driver.find_element(by=By.CSS_SELECTOR, value="#user_remember_me")
    ...
    def is_loaded(self) -> Self:
        _ = self.email_input_visible
        return self

    def login(self, email: str, password: str, remember_me: bool = False) -> Self:
        """Authenticates user with credentials and optional persistence"""
