...
INVALID_LOGIN_TEST_DATA = [
    ...
    pytest.param("user name@domain.com", fake.password(length=10), id="email_with_spaces"),
...
def test_login_invalid(email: str, password: str, configs: Configs, session_app: Application):
    (session_app.login_page.open().is_loaded().login(email, password).invalid_login_message_visible())
